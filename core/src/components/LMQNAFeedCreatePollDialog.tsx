...
import LMQNAPollDialogPreview from "./LMQNAFeedPollDialogPreview";

interface LMQNACreatePollDialogProps {
}
...
const LMQNACreatePollDialog = ({ }: LMQNACreatePollDialogProps) => {
...
export default LMQNACreatePollDialog;
